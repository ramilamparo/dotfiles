...
| `Mod+d` | Open application launcher (wofi drun) |
| `Mod+Shift+d` | Open command runner (wofi run) |
| `Mod+Tab` | Window switcher (wofi window) |
...
| `Mod+Shift+space` | Toggle floating (pacman-wofi) |
...
| `Mod+Shift+grave` | Toggle Do Not Disturb |
